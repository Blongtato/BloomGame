...
- Click **Bring it to the light** - start a run

Each run shuffles four dense, pre-made obstacle-room layouts before the final window room. Entry and exit doors appear on different randomly selected walls each room; cobwebs can be crossed, but reduce movement speed substantially.
